...
export const specializationData: Record<string, any>[] = [
    { Animals: 1, Id: 'generalmedicine', Text: 'General Medicine', Color: '#F538B2' },
    { Animals: 2, Id: 'neurology', Text: 'Neurology', Color: '#33C7E8' },
    { Animals: 3, Id: 'dermatology', Text: 'Dermatology', Color: '#916DE4' },
    { Animals: 4, Id: 'orthopedics', Text: 'Orthopedics', Color: '#388CF5' },
    { Animals: 5, Id: 'diabetology', Text: 'Diabetology', Color: '#60F238' },
    { Animals: 6, Id: 'cardiology', Text: 'Cardiology', Color: '#F29438' }
];
